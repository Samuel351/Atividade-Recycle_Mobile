...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listpers.add(new Personagem("Yasuo", "10", R.drawable.yasuo));
        listpers.add(new Personagem("Ziggs", "10", R.drawable.ziggs));
        listpers.add(new Personagem("Morgana", "10", R.drawable.morgana));
        listpers.add(new Personagem("Yone", "10", R.drawable.yone));
        listpers.add(new Personagem("Captain Price", "10", R.drawable.captainprice));
        listpers.add(new Personagem("Smoke", "10", R.drawable.smoke));
        listpers.add(new Personagem("Ash", "10", R.drawable.ash));
        listpers.add(new Personagem("Kratos", "10", R.drawable.kratos));
        listpers.add(new Personagem("Darius", "10", R.drawable.darius));
